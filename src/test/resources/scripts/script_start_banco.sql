...
#Categoria
INSERT INTO `mantis_category_table` (`id`, `project_id`, `user_id`, `name`, `status`) VALUES (1, 0, 0, 'Categoria A', 0);
INSERT INTO `mantis_category_table` (`id`, `project_id`, `user_id`, `name`, `status`) VALUES (2, 0, 0, 'Categoria B', 0);
#Usuários
...
#Perfil/Profile
INSERT INTO `mantis_user_profile_table` (`id`, `platform`, `os`, `os_build`, `description`) VALUES ('1', 'Plataforma Default A', 'SO Default A', 'Versão Original A', 'Descrição sobre o sistema operacional default A');
INSERT INTO `mantis_user_profile_table` (`id`, `platform`, `os`, `os_build`, `description`) VALUES ('2', 'Plataforma Default B', 'SO Default B', 'Versão Original B', 'Descrição sobre o sistema operacional default B');
#Bug
INSERT INTO `mantis_bug_text_table` (`description`) VALUES ('Descrição default: Primeiro report');
INSERT INTO `mantis_bug_table` (`project_id`,`reporter_id`,`bug_text_id`,`summary`,`date_submitted`,`last_updated`) VALUES ('1','1','1','Resumo default: Primeiro report','1630271419','1630271419');
INSERT INTO `mantis_bug_text_table` (`description`) VALUES ('Descrição default2: Segundo report');
INSERT INTO `mantis_bug_table` (`project_id`,`reporter_id`,`bug_text_id`,`summary`,`date_submitted`,`last_updated`) VALUES ('1','1','2','Resumo default2: Segundo report','1630271419','1630271419');